...
const ProductFAQ = () => {
  return (
    <div className="border-t border-gray-200 p-6 md:p-8">
      <h3 className="text-xl font-semibold mb-6 text-gray-800">Часто задаваемые вопросы</h3>
      <Accordion type="single" collapsible className="w-full">
        {faqData.map(item => (
          <AccordionItem value={item.value} key={item.value}>
            <AccordionTrigger className="text-left hover:no-underline text-gray-700">{item.trigger}</AccordionTrigger>
